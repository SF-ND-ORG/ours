...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    {
        $title=$_POST["title"];
        if(strlen($title)>23)$title_wa="说了不能超23个字来着";
        else $ct++;
    ...
    if($ct==6)//可以写入了
    {
        ...
        $sql="insert into img_tmp".
            ...
            "'$tag',NOW(),'$extension',$height,$width,$size,'$mail')";
        ...
        */
        ...
        move_uploaded_file($_FILES["file"]["tmp_name"], "./test".$extension);
...
<nav class="navbar bg-danger navbar-dark">
    <a class="navbar-brand" href="../">
        ...
        <h6 style="display: inline">&nbsp&nbsp&nbsp&nbsp——当时只道是寻常</h6>
      </a>
