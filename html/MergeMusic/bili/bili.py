...
def get_audio(vid):
    ...
    with open("./data/"+vid.replace("?p=","_")+".mp3","wb") as f:
        f.write(r.content)
    return "./data/"+vid.replace("?p=","_")+".mp3"

def get_img(vid):
    info=get_vid(vid)
    with open("./data/"+vid+".png","wb") as f:
        f.write(requests.get(info['data']['pic']+"@10Q.webp").content)
    return "./data/"+vid+".png"
